...
const CustomerLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const response = await fetch("http://localhost:8080/api/user-customer/login", {
        method: "POST",
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full bg-gradient-to-br from-blue-100 via-pink-100 to-green-100 flex items-center justify-center">
        <form
